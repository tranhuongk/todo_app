...
extension AppFontColor on TextStyle {
  ...
  TextStyle get lightGrayColor => copyWith(color: AppColors.lightGray);

  /// color: AppColors.kPrimaryColor,
  TextStyle get kPrimaryColor => copyWith(color: AppColors.kPrimaryColor);

  /// color: AppColors.neutral3,
  TextStyle get hintTextColor => copyWith(color: AppColors.hintTextColor);
...
extension AppFontFamily on TextStyle {
  ...
  TextStyle get filsonPro => copyWith(fontFamily: "Filson Pro");
}
